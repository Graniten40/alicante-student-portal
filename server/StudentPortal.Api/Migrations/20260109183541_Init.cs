    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackContents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PackContents_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PackContents_ProductId",
                table: "PackContents",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Progress_UserId_ProductId_StepKey_TaskKey",
                table: "Progress",
                columns: new[] { "UserId", "ProductId", "StepKey", "TaskKey" },
                unique: true);
        }
